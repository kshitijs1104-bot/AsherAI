...
export const OWNER_NAME = POLICY_META.parentEntity || "Praecelsia Holdings";
...
export const POLICY_SECTIONS: readonly PolicySection[] = [
  {
    ...
    body: [
      `Asher is a private operating system for founders, built and operated by ${OWNER_NAME}, which is the company you are agreeing with here. This policy covers the Asher web app, the API behind it, and the marketing site. It explains what we hold about you and your company, why, who else touches it, and what you can tell us to stop doing.`,
      'Asher is a business tool. It is built for founders and operators, and offered to businesses and professionals for use in connection with their business; it is not offered, marketed or intended for personal, family or household use. If you use Asher, you do so in a business capacity, whether that is your own business or one you work for, and not as a consumer.',
      'Asher accounts are individual today; there is no shared or organisation-level account, and nobody but you can reach what is stored under your account, in the way section 21 describes. If that ever changes: a shared workspace, an invited teammate, anything that gives someone other than you access to what you have built in Asher. This policy will be updated to say exactly what that means for visibility inside it, and you will be asked to read and accept the change before any shared access begins, the same way section 12 already governs any other change.',
      'Asher is a product for businesses, and we ask for a work email address when you sign up. We do not direct Asher at children, we do not market it to them, and we do not knowingly collect personal data from a child. If you believe a child has given us data, write to us at the address in section 13 and we will delete it.',
      ...
      'Sections 1 to 13 are the privacy policy. Sections 14 to 18 are the terms on which Asher is provided: ownership, the limits of what Asher can promise you, and the limits of what we are liable for. Sections 19 onward are additional disclosures: cookies, region-specific rights, and definitions. Using Asher means agreeing to all of it.',
    ],
  },
  {
    id: 'collect',
    ...
    body: [
      ...
      [
        ...
        'Business profile: company name, stage, industry, team size, country, revenue figure and primary goal, from the onboarding steps and from Settings. This is attached to every request Asher makes on your behalf.',
        'What you say to Asher: the full text of your messages and Asher\'s replies, stored server-side as a durable log so that threads, decisions and goals stay linked to each other over months.',
        'What Asher derives from you: facts about your company, decisions, goals, roadmap items, learnings, monthly reviews and confidence scores. This is the memory layer; it is the product.',
        'Files you upload: images and documents you attach in the composer. The file is stored on our server, and its text or visual content is extracted once so Asher can read it without re-reading the file on every question.',
  ...
  },
  {
    ...
    body: [
      [
        'Running Asher — answering you, remembering context between sessions, building your dossier, tracking goals and decisions, and assembling the monthly review.',
        'Making Asher better at advising you — storing and training on your content, described in full in section 4 because it is the mechanism the whole product rests on.',
  ...
  {
    id: 'training',
    heading: '4. How Asher stores and learns from your data',
    body: [
      'Asher works by remembering your business. It stores what you tell it and learns from it, which is what lets it pick up a decision you made months ago instead of asking you to explain your company over again, and what lets its judgement keep improving the more it works with you: a colleague who remembers your last conversation is more useful than one who does not.',
      'What that covers: your messages and Asher\'s replies, the facts and decisions Asher derives from them, the extracted content of files you upload, and any feedback you give on a response.',
      'Storing and learning from your content is built into how Asher works, not a separate feature layered on top of it, so it is part of using Asher rather than a switch you set independently of the rest of the product. If you would rather your content were not stored or learned from, closing your account (section 7) removes everything we hold, and where the law of your country gives you a right to object to this specific processing, section 9 explains how to raise it.',
      'For readers in the UK or EEA, this is our lawful basis under the GDPR, named directly rather than left for you to infer. Storing your content and using it to answer you (the core function of the product) is necessary for the performance of our contract with you (Article 6(1)(b)). Using that content, usually aggregated and stripped of anything that identifies your company, to improve Asher\'s judgement more broadly is based on our legitimate interests in operating and developing the product (Article 6(1)(f)), weighed against your right to privacy. This is why section 4 limits what that involves, and why Article 21 gives you a right to object to it. Where you object, honouring that in practice means closing the account, for the reason already given: there is no version of Asher that runs without this.',
      'What we limit, and hold ourselves to:',
      [
        'We aggregate and strip identifiers wherever the work does not require them. This is most of the time, because what we are usually trying to learn is a pattern, not a company.',
  ...
  },
  {
    ...
    body: [
      'Asher runs on other companies\' infrastructure. These are the ones that see your data, and exactly what each one gets. None of them pays us for access, and none of them is free to use your data for their own purposes.',
      [
        'Our authentication provider (Clerk): your name, email and session data. It is how sign-in works.',
        'Our model provider (Groq): the contents of the request Asher is answering: your question plus the context Asher assembled for it. This is how an answer gets generated. We send the minimum the answer needs and no more.',
        ...
        'Web search and page retrieval (DuckDuckGo, Jina Reader): when a question needs current outside information, the search terms Asher constructs are sent out. Your identity is not attached to them.',
  ...
  },
  {
    ...
    body: [
      ...
      'While your account is open, we keep what section 2 describes, because Asher\'s usefulness is a direct function of how much of your history it still has. Technical and request logs are kept for up to 90 days and then discarded.',
    ],
  },
  {
    id: 'security',
    ...
    body: [
      'Your data is the record of how your company actually runs, and it is treated that way: encrypted, access-controlled, and used to power your experience with Asher. It is not handed to outside companies. We do not share it with advertisers, data brokers, or anyone outside the small set of infrastructure and connector providers named in section 5, each of which is contractually bound to use it only to help run Asher for you.',
      [
  ...
  },
  {
    ...
    body: [
      ...
      [
        ...
        'Opt out of anything that is not required for Asher to function: product email, and any future processing that section 12 introduces.',
      ...
      'The one thing you cannot switch off while continuing to use Asher is the storing of and training on your content, for the reason given in section 4: it is not a feature layered on top of Asher, it is how Asher works. Your control over it is the control described in section 7: delete the chat, or close the account and take everything with you.',
  ...
  },
  {
    ...
    body: [
      `We operate from ${POLICY_META.jurisdiction}, and the providers in section 5 operate in the United States and the European Union. Using Asher means your data crosses borders. Where it leaves a jurisdiction that restricts transfers, the mechanism we rely on is the European Commission's Standard Contractual Clauses; and, for transfers out of the UK, the UK's International Data Transfer Addendum to those clauses. These are incorporated into our contracts with the providers in section 5. We do not transfer data to a provider that has not signed one.`,
    ],
  },
  {
    id: 'compliance',
    ...
    body: [
      ...
      'Our commitment underneath all of it is simpler than the statutes: your data is used to run Asher and to make Asher better for you. It is not misused, not sold, not repurposed for something you would not expect, and not treated as an asset separate from the service you came here for.',
    ],
  },
  {
    id: 'changes',
    ...
    body: [
      'This policy is versioned. If we change what we actually do with your data, then before the change takes effect we will bump the version, email you, and ask you to read and accept the new wording the next time you open Asher. Small clarifications that do not change meaning we will simply date.',
      'You will not be treated as having agreed to a material change by silence, by continuing to use Asher, or by not reading an email. And where a change introduces processing that is not necessary for Asher to function, you will be able to decline that part specifically and keep using Asher without it. Only what section 4 describes is non-optional.',
  ...
  },
  {
    ...
    body: [
      ...
      'For readers in India: the address above is also our Grievance Officer contact under the Digital Personal Data Protection Act. We acknowledge a grievance within 7 days and aim to resolve it within 30 days. This is the same window every other request in section 9 gets.',
    ],
  },
];
...
export const ADDITIONAL_SECTIONS: readonly PolicySection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      [
        ...
        'Professional information: your role, your company\'s name, stage and industry. To calibrate Asher\'s advice to your business.',
        'Inferences drawn from the above: the facts, decisions and patterns Asher derives from your activity (section 2). This is the memory layer the product is built on.',
      ],
  ...
  },
  {
    ...
    body: [
      'Files you upload in Asher are used by you, for you. Nothing you upload is published or made visible to anyone outside your own account. Because of that, the situation this section exists for (someone claiming material visible to other users infringes their rights) does not really arise in how Asher works today. We are stating a process anyway, so a legitimate complaint always has somewhere to go, and so there is one if that ever changes.',
      `If you believe something on Asher infringes your copyright or other intellectual property rights, write to the address in section 13 with: a description of the work you claim is infringed, the specific material you are complaining about and where it is, your contact details, and a good-faith statement that the use is not authorised. We will investigate and, where the complaint is valid, remove or disable access to the material and tell the account holder why.`,
    ],
  },
  {
    id: 'survival',
  ...
  },
  {
    ...
    body: [
      'Most disagreements get resolved faster one-on-one than in a courtroom or as part of a group action. This section is about the disputes between you and us over these terms or your use of Asher. It does not limit your right to complain to a data protection authority or other regulator, which section 9 covers separately and which cannot be signed away.',
      [
        `You and ${OWNER_NAME} agree to resolve any dispute arising out of or relating to these terms or your use of Asher through binding arbitration on an individual basis, rather than in court, except where this section says otherwise. Choosing arbitration means both of us are giving up the right to a jury trial and to litigate this in court.`,
  ...
  },
  {
    ...
    body: [
      ...
      [
        `"Asher", "we", "us" or "our" means ${OWNER_NAME}.`,
        '"You" or "your" means the person or business using Asher under an account.',
        '"Content" means anything you type, upload, connect or otherwise submit to Asher, and anything Asher generates in response.',
...
export const OWNERSHIP_SECTIONS: readonly PolicySection[] = [
  {
    id: 'ownership',
    heading: '14. Asher is our property',
    body: [
      `${OWNER_NAME} owns Asher. The name and mark are our trademark. The exact design, layout and visual presentation of our screens (the landing page, the chat interface, the dossier, and every other page) is our copyrighted work. The software, our prompts and system instructions, the memory and dossier architecture, our model configuration and our documentation are our confidential and proprietary information, held as trade secrets and protected by the licence terms below. Nothing in this document transfers any of it to you.`,
      'What you get instead is a licence: a limited, non-exclusive, non-transferable, revocable right to use Asher as a customer, for your own business, for as long as your account is in good standing. That is the whole of the grant.',
      'Without our written permission, you may not:',
      [
        'copy, reproduce, republish, mirror or redistribute any part of Asher, including its interface, its copy, or its outputs presented as a product of your own;',
        'reverse-engineer, decompile or otherwise attempt to derive our prompts, system instructions or internal logic;',
        'scrape, crawl or bulk-extract from Asher by any automated means, or access it other than through the interfaces we provide;',
        'resell, sublicense, rent, white-label or otherwise make Asher available to anyone outside your company;',
        'use Asher, or its outputs, to build, train or evaluate a competing product or a model intended to replicate it;',
      ...
      `We enforce this. Breach ends the licence immediately and we reserve every remedy available to us, including injunctive relief and recovery of costs. If you have found someone copying Asher, tell us at ${POLICY_META.contactEmail}.`,
    ],
  },
  {
    id: 'your-content',
    ...
    body: [
      'The reciprocal half, and it matters as much: your business data, your files and what you write to Asher remain yours. We claim no ownership of them.',
      'What you grant us is a licence to store and process that content for the purposes set out in this policy: running Asher for you, and training and improving it as described in section 4. Nothing more. If you close your account, that licence ends with it and the content is deleted under section 7.',
      'What Asher writes back to you (analyses, drafts, reviews, recommendations) is yours to use in your business freely, including commercially, subject only to section 14: do not present Asher itself as your own product.',
    ],
  },
  {
    id: 'no-advice',
    ...
    body: [
      'Read this section properly. It is the one that describes what Asher is not.',
      'Asher produces analysis and recommendations generated by a language model from the information available to it. It can be wrong, and it can be wrong while sounding certain. It can misread a number, miss context you did not give it, rely on outdated information, or reason from a false premise. Accuracy is what we build towards; it is not something we can guarantee, and nothing in the product or our marketing should be read as guaranteeing it.',
      'That includes our marketing language. Phrases used to describe Asher (including "the cause behind every decision" and any similar claim on our website, in advertising, or in the product) describe what Asher is designed to do and what it aims at. They are positioning, not a warranty. Asher does not and cannot guarantee that it has identified the true cause of anything, that a recommendation is correct, or that following it will produce a particular result.',
      'Asher is not professional advice of any kind, and using it creates no professional or fiduciary relationship between us. It is not legal, financial, investment, tax, accounting, regulatory, employment, insurance, engineering, medical, psychological or safety advice, and it is not a substitute for a qualified, accountable, licensed human being. Specifically:',
      [
        'Every output is information for you to evaluate, not an instruction to follow and not a decision made on your behalf.',
        'Every decision you make after reading a Asher output remains entirely your decision, made on your own judgement and at your own risk.',
        ...
        'Asher has no way to know your full circumstances, and its outputs are not tailored advice even when they read as though they are.',
      ],
      'To the fullest extent the law allows, Asher is provided "as is" and "as available", with no warranties of any kind, whether express, implied or statutory. We specifically disclaim any implied warranty of merchantability, fitness for a particular purpose, accuracy, completeness, reliability, non-infringement, and uninterrupted or error-free operation. We do not warrant that Asher will be available at any given time, that it will be free of bugs or defects, that any defect will be fixed, that data will never be lost, or that outputs will be consistent between one request and the next.',
    ],
  },
  {
    id: 'liability',
    ...
    body: [
      'Asher produces analysis, recommendations and information generated by an artificial intelligence system. Any decision, action or omission taken in reliance on that output is undertaken entirely at your own discretion and at your own risk, and not at our direction.',
      'To the fullest extent permitted by applicable law, and except where this section provides otherwise:',
      [
        'We disclaim liability for any loss, damage, cost or expense arising out of or in connection with your use of, or reliance upon, Asher or any output it produces. This includes any decision you took, did not take, or delayed as a result.',
        ...
        'Our total aggregate liability for all claims arising out of or relating to Asher or these terms, however arising and whether in contract, tort (including negligence), statute or otherwise, is limited to the greater of the total fees you paid us for Asher in the twelve months before the claim arose, or one hundred United States dollars (US$100).',
      ],
  ...
  },
  {
    ...
    body: [
      ...
      [
        'Use Asher lawfully, and do not use it to break the law, infringe anyone\'s rights, or harm anyone.',
        'Only put data into Asher that you are entitled to share. If you paste someone else\'s personal data (a customer list, an employee\'s details, a third party\'s confidential information), you are confirming you have the right to, and you are responsible for that.',
      ...
      'You agree to indemnify us against third-party claims, losses and reasonable costs arising from your breach of this section. This includes any claim brought by someone whose data you put into Asher without the right to do so. This does not apply to anything caused by our own breach, negligence or wrongdoing.',
