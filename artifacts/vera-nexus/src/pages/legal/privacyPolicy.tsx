...
export const OWNER_NAME = POLICY_META.parentEntity || "Asher's parent company";
...
export const POLICY_SECTIONS: readonly PolicySection[] = [
  ...
  },
  {
    ...
    body: [
      'Your data is the record of how your company actually runs, and it is treated that way: encrypted, access-controlled, and used to power your experience with Asher — not handed to outside companies. We do not share it with advertisers, data brokers, or anyone outside the small set of infrastructure and connector providers named in section 5, each of which is contractually bound to use it only to help run Asher for you.',
      [
...
export const OWNERSHIP_SECTIONS: readonly PolicySection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      [
        'We disclaim liability for any loss, damage, cost or expense arising out of or in connection with your use of, or reliance upon, Asher or any output it produces — including any decision you took, did not take, or delayed as a result.',
  ...
  },
  {
    ...
    body: [
      ...
      'You agree to indemnify us against third-party claims, losses and reasonable costs arising from your breach of this section — including any claim brought by someone whose data you put into Asher without the right to do so. This does not apply to anything caused by our own breach, negligence or wrongdoing.',
