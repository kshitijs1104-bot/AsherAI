  ...
  if (subTasks.length === 0) {
    return (
      <div className="text-[12px] mt-3" style={{ color: 'var(--v7-text-mute)' }}>
        No roadmap items yet — the next decision or roadmap card Asher gives you in this chat becomes evidence here automatically.
      </div>
    );
  }
  return (
  ...
  return (
    <div>
      ...
      <div className="text-[11px] mb-3" style={{ color: 'var(--v7-text-mute)' }}>
        All four are required — without a concrete metric, value, and deadline Asher can't reason about urgency or trade-offs in this chat.
      </div>
      ...
      {!goal && !editing && (
        <div>
          <div className="text-[12px] mb-2" style={{ color: 'var(--v7-text-mute)' }}>
            Give this chat one named goal — Asher will weigh urgency, value, and trade-offs against it in every answer here.
          </div>
          <button
